...
Для объекта Post, 7 запросов, были созданы скрипты автотестов, проверяющие код статуса ответа каждого запроса, получен ли OK по каждому запросу, время выполнения запроса (меньше ли оно 5000 мс). 
